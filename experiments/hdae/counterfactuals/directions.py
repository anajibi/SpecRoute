...
def summarize_attribute_changes(before: np.ndarray, after: np.ndarray, target_index: int,
    ...
    return {
        ...
        "non_target_flip_count_mean": float(non_target_flips.sum(axis=1).mean()),
